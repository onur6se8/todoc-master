...
public class MainActivity extends AppCompatActivity implements TasksAdapter.DeleteTaskListener {
     ...
     */
    private TasksAdapter adapter; // final    = new TasksAdapter(tasks, this);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sortMethod = (SortMethod) getLastCustomNonConfigurationInstance();
        if (sortMethod == null) {
    ...
    private void configureRecyclerView() {
        ...
        this.listTasks.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));  // . 2
    }
    ...
    private void getTasks() {                                                // okkkkkkkkkkkkkkkkkkkkkkkkk
